...
import wishlist.domain.application.endpoint.add_wishlist.AddWishlistEndpoint;
...
class AddWishlistEndpointTest {
    ...
    void shouldReturnTrueWith200_whenProductExists() {
        ...
        var expectedResponse = new CommonWishlist.Builder()
        ...
        var endpoint = new AddWishlistEndpoint(saveWishlistUseCase);
